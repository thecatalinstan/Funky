...
inline static void RVNCheckReceiptIDAndVersion(NSString* theBundleIdentifier, NSString* thebundleVersion, NSDictionary *receiptInfo)
{
    NSString *bundleID = [receiptInfo valueForKey:kRVNReceiptInfoKeyBundleID];
    if (![bundleID isEqualToString:theBundleIdentifier]) {
...
//    if (![bundleVersion isEqualToString:thebundleVersion]) {
//        NSLog(@"%@ = %@", bundleVersion, thebundleVersion);
...
void RVNValidate(void)
{
    ...
    RVNCheckReceiptIDAndVersion(bundleIdentifier, bundleVersion, receiptInfo);
